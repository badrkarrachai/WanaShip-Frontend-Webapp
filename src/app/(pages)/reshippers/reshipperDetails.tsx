...
interface reshipperDetailsProps {
  isOpen: boolean;
  onOpenChange: any;
}

const ReshipperDetailsModal: FC<reshipperDetailsProps> = ({
  isOpen,
  onOpenChange,
}) => {
  return (
          ...
          {(onClose) => (
            <>
              ...
              <ModalBody className="flex flex-col gap-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <WaInput
                    ...
                    endContent={<AnimatedCopyContent value="Badr Karrachai" />}
                  />
                  <WaInput
                    type="text"
                    label="Email"
                    ...
                    endContent={
                      <AnimatedCopyContent value="BadrKarrachai@gmail.com" />
                    }
                  />
                  <PhoneInputWithCountryCode
                    endContent={<AnimatedCopyContent value="603872478" />}
                  />
                  <WaInput
                    type="text"
                    label="Country"
                    ...
                    endContent={<AnimatedCopyContent value="USA" />}
                  />
                  <WaInput
                    type="text"
                    label="State"
                    ...
                    endContent={<AnimatedCopyContent value="New York State" />}
                  />
                  <WaInput
                    type="text"
                    label="City"
                    ...
                    endContent={<AnimatedCopyContent value="New York" />}
                  />
                  <WaInput
                    type="text"
                    ...
                    endContent={
                      <AnimatedCopyContent value="123 Main Street, New York, NY 10012" />
                    }
                  />
                  <WaInput
                    type="text"
                  ...
                  <WaInput
                    ...
                    endContent={<AnimatedCopyContent value="10012" />}
                  />
                  <Textarea
                    label="Reshipper Note"
                    startContent={
                      <ScrollText className=" text-gray-600" size={17} />
                    }
                    endContent={<AnimatedCopyContent value="No notes" />}
              ...
              <ModalFooter className="flex justify-start sm:justify-end gap-3 flex-wrap-reverse">
                ...
                <Button className="py-5 sm:px-6 text-gray-50 dark:text-gray-900 bg-WaPurple font-medium ">
                  <Bookmark size={16} className="" /> Claime
                </Button>
              </ModalFooter>
            </>
          )}
...
export default ReshipperDetailsModal;
