    ...
    >
      ...
      <p
        className={cx(
          ...
          hasOnValueChange &&
            "group-hover:text-gray-900 dark:group-hover:text-gray-800",
          activeLegend && activeLegend !== name ? "opacity-40" : "opacity-100"
        )}
      >
        {name}
    ...
    return (
      <div
        className={cx(
          ...
          // border color
          "border-gray-200 dark:border-WaBorderDark",
          // background color
          "bg-white  dark:bg-opacity-35 backdrop-blur-lg dark:bg-[#303656]"
        )}
      >
...
const AreaChart = React.forwardRef<HTMLDivElement, AreaChartProps>(
  (props, ref) => {
    ...
    const paddingValue =
      (!showXAxis && !showYAxis) || (startEndOnly && !showYAxis) ? 0 : 0;
      ...
      >
        <ResponsiveContainer>
          ...
          >
            {showGridLines ? (
              <CartesianGrid
                className={cx("stroke-gray-200 stroke-1 dark:stroke-gray-200")}
                horizontal={true}
                vertical={false}
              />
            ) : null}
            ...
            {onValueChange
              ? categories.map((category) => (
                  <Line
                    ...
                    key={category}
                    name={category}
                    type="monotone" // This creates a smooth curve
                    dataKey={category}
                    stroke="transparent"
                    fill="transparent"
                    legendType="none"
